  ...
  execute: async (message, args, client, prefix, player, guildData) => {
    ...
    if (user) {
      ...
      const embed = new client.embed()
        ...
        .setImage(client.config.links.icon);
