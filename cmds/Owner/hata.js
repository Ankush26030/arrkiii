...
const OxP1 = require("@data/noprefix");
const OxP2 = require("@data/votebypassuser");
const OxP3 = require("@data/badge");
    ...
    if (args[1] === "nop") {
      ...
      if (!npData)
        return message.reply({
          content: `This user is not present in my no prefix system.`,
        });
